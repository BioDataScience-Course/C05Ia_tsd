...
[] -   Par rapport à l'analyse spectrale sur les différences, le spectre montre une sélection d'un cycle annuel avec échos significatifs à 2, 3, 4 et 5 ans (à cause du lissage par moyennes mobiles).
[] -   Par rapport à l'analyse spectrale sur les différences, le spectre montre une sélection d'un cycle annuel avec échos non significatifs à 2, 3, 4 et 5 ans (à cause du lissage par moyennes mobiles).}-")
```
